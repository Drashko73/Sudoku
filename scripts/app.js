...
function get_username() {
    ...
    for (const cookie of cookies) {
        ...
        if (cookieName === "firstName") name += cookieValue;
    }

    return name;
}

name_input.innerHTML = get_username();
// --------
...
function setPlayerName(name) {
    localStorage.setItem('player_name', get_username());
}
                ...
                if (isGameWin()) {
                    ...
                    xmlhttp.onreadystatechange = function () {
                        if (this.readyState == 4 && this.status == 200) {
                            ...
                            if (response != 'False') {
                                // console.log(game_level.innerHTML);
                    ...
                    xmlhttp.open("GET", `../cgi-bin/requests.py?increase_total_completed=1&email=${getCookie("email")}&level=${game_level.innerHTML}&time=${showTime(seconds)}`, true);
                    xmlhttp.send();
                }
                // ----
            }
